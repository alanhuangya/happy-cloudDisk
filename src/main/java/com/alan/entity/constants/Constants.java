package com.alan.entity.constants;
...
public class Constants {
    ...
    // redis中邮箱消息的键
    public static final String REDIS_KEY_SYS_SETTING = "cloudDisk:syssetting";
    ...
    public static final String REDIS_KEY_DOWNLOAD = "cloudDisk:download:";


    public static final String REDIS_KEY_USER_SPACE_USE = "cloudDisk:user:spaceuse:";

    public static final String REDIS_KEY_USER_FILE_TEMP_SIZE = "cloudDisk:user:file:temp";
